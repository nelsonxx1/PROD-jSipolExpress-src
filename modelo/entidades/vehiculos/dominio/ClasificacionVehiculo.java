 ...
 */
@Entity
public class ClasificacionVehiculo extends BeanVO implements Serializable, Auditable {
    ...
    public ClasificacionVehiculo(String nombre, AuditoriaBasica auditoria) {
        this.nombre = nombre;
