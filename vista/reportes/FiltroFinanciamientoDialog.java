 ...
 * @author PAPA
 */
public class FiltroFinanciamientoDialog extends InternalFrame {
    ...
    public FiltroFinanciamientoDialog(Reporte reporte, String estilo) {
        initComponents();
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jFormattedTextField2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jComboBox1, jComboBox2, jComboBox3, jComboBox4});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel10, jLabel4, jLabel6, jLabel8});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jFormattedTextField1, jFormattedTextField2, jFormattedTextField3, jFormattedTextField4});
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel13, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 246, Short.MAX_VALUE)
                    .addComponent(jLabel14, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 246, Short.MAX_VALUE)
        ...
        labelControl13.setLabel("financiadora");

        codLookupControl8.setAttributeName("financiadora.nombreLargo");
            ...
            .addGroup(form1Layout.createSequentialGroup()
                ...
                .addGroup(form1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(form1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(codLookupControl2, javax.swing.GroupLayout.DEFAULT_SIZE, 451, Short.MAX_VALUE))
                    .addGroup(form1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(codLookupControl3, javax.swing.GroupLayout.DEFAULT_SIZE, 451, Short.MAX_VALUE))
                    .addGroup(form1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(codLookupControl4, javax.swing.GroupLayout.DEFAULT_SIZE, 451, Short.MAX_VALUE))
                    .addGroup(form1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(codLookupControl5, javax.swing.GroupLayout.DEFAULT_SIZE, 451, Short.MAX_VALUE))
                    .addGroup(form1Layout.createSequentialGroup()
                        .addGroup(form1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(labelControl13, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(form1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(codLookupControl7, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 451, Short.MAX_VALUE)
                            .addComponent(codLookupControl6, javax.swing.GroupLayout.DEFAULT_SIZE, 451, Short.MAX_VALUE)
                            .addComponent(codLookupControl8, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 451, Short.MAX_VALUE))))
                .addContainerGap())
        );
        ...
        form1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {codLookupControl2, labelControl10, labelControl11, labelControl12, labelControl13, labelControl7, labelControl8, labelControl9});
    ...
    class FiltroRecibos extends FormController implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            financiadora = ((FiltroFinanciamiento) FiltroFinanciamientoDialog.this.form1.getVOModel().getValueObject());
            ...
            if (financiadora.getCobrador() != null && financiadora.getCobrador().getId() != null) {
                FilterWhereClause cob[] = new FilterWhereClause[2];
                cob[0] = new FilterWhereClause("cobrador2.id", "=", financiadora.getCobrador().getId());
                vacio = false;
                filtros.put("cobrador2.id", cob);
            }
            if (financiadora.getCompania() != null && financiadora.getCompania().getId() != null) {
                FilterWhereClause com[] = new FilterWhereClause[2];
                com[0] = new FilterWhereClause("poliza.compania.id", "=", financiadora.getCompania().getId());
                vacio = false;
                filtros.put("poliza.compania.id", com);
            }

            if (financiadora.getGrupo() != null && financiadora.getGrupo().getId() != null) {
                FilterWhereClause gru[] = new FilterWhereClause[2];
                gru[0] = new FilterWhereClause("poliza.grupoPoliza.id", "=", financiadora.getGrupo().getId());
                vacio = false;
                filtros.put("poliza.grupoPoliza.id", gru);
            }

            if (financiadora.getProductor() != null && financiadora.getProductor().getId() != null) {
                FilterWhereClause pro[] = new FilterWhereClause[2];
                pro[0] = new FilterWhereClause("poliza.productor.id", "=", financiadora.getProductor().getId());
                vacio = false;
                filtros.put("poliza.productor.id", pro);
            }

            if (financiadora.getRamo() != null && financiadora.getRamo().getId() != null) {
                FilterWhereClause ram[] = new FilterWhereClause[2];
                ram[0] = new FilterWhereClause("poliza.ramoPoliza.id", "=", financiadora.getRamo().getId());
                vacio = false;
                filtros.put("poliza.ramoPoliza.id", ram);
            }

            if (financiadora.getTipoZona() != null && financiadora.getTipoZona().getId() != null) {
                FilterWhereClause zon[] = new FilterWhereClause[2];
                zon[0] = new FilterWhereClause("zona.id", "=", financiadora.getTipoZona().getId());
                vacio = false;
                filtros.put("zona.id", zon);
            }
            if (financiadora.getFinanciadora() != null && financiadora.getFinanciadora().getId() != null) {
                FilterWhereClause fin[] = new FilterWhereClause[2];
                fin[0] = new FilterWhereClause("zona.id", "=", financiadora.getFinanciadora().getId());
                vacio = false;
                filtros.put("financiadoras.id", fin);
            }
            ...
            switch (jTabbedPane1.getSelectedIndex()) {
                case 0:
                    if (jComboBox1.getSelectedIndex() > 0) {
                        ...
                        parametros[0] = new FilterWhereClause("fechaCobro", ">=", desde2.getTime());
                        parametros[1] = new FilterWhereClause("fechaCobro", "<", hasta2.getTime());
                        filtros.put("fechaCobro", parametros);
                    }
                    if (jComboBox2.getSelectedIndex() > 0) {
                        vacio = false;
                        ...
                        parametros[0] = new FilterWhereClause("fechaPagoComision", ">=", desde2.getTime());
                        parametros[1] = new FilterWhereClause("fechaPagoComision", "<", hasta2.getTime());
                        filtros.put("fechaPagoComision", parametros);
                    }
                    if (jComboBox3.getSelectedIndex() > 0) {
                        vacio = false;
                        ...
                        parametros[0] = new FilterWhereClause("vigenciaDesde", ">=", desde2.getTime());
                        parametros[1] = new FilterWhereClause("vigenciaDesde", "<", hasta2.getTime());
                        filtros.put("vigenciaDesde", parametros);
                    }
                    if (jComboBox4.getSelectedIndex() > 0) {
                        vacio = false;
                ...
                case 1:
                    if (dateControl1.getDate() != null && dateControl2.getDate() != null) {
                        FilterWhereClause parametros[] = new FilterWhereClause[2];
                        parametros[0] = new FilterWhereClause("fechaCobro", ">=", dateControl1.getDate());
                        parametros[1] = new FilterWhereClause("fechaCobro", "<=", dateControl2.getDate());
                        filtros.put("fechaCobro", parametros);
                        vacio = false;
                    ...
                    if (dateControl3.getDate() != null && dateControl4.getDate() != null) {
                        FilterWhereClause parametros[] = new FilterWhereClause[2];
                        parametros[0] = new FilterWhereClause("fechaPagoComision", ">=", dateControl3.getDate());
                        parametros[1] = new FilterWhereClause("fechaPagoComision", "<=", dateControl4.getDate());
                        filtros.put("fechaPagoComision", parametros);
                        vacio = false;
                    ...
                    if (dateControl5.getDate() != null && dateControl6.getDate() != null) {
                        FilterWhereClause parametros[] = new FilterWhereClause[2];
                        parametros[0] = new FilterWhereClause("vigenciaDesde", ">=", dateControl5.getDate());
                        parametros[1] = new FilterWhereClause("vigenciaDesde", "<=", dateControl6.getDate());
                        filtros.put("vigenciaDesde", parametros);
                        vacio = false;
                    ...
                    if (dateControl7.getDate() != null && dateControl8.getDate() != null) {
                        FilterWhereClause parametros[] = new FilterWhereClause[2];
                        parametros[0] = new FilterWhereClause("vigenciaHasta", ">=", dateControl7.getDate());
                        parametros[1] = new FilterWhereClause("vigenciaHasta", "<=", dateControl8.getDate());
                        filtros.put("vigenciaHasta", parametros);
                        vacio = false;
