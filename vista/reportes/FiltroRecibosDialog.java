 ...
 * @author PAPA
 */
public class FiltroRecibosDialog extends InternalFrame {

    private Reporte reporte;
    private String estilo;
    private FiltroRecibo recibo;
    ...
    public FiltroRecibosDialog(Reporte reporte, String estilo) {
        initComponents();
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jFormattedTextField2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jFormattedTextField4, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(96, 96, 96))
        );
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jComboBox1, jComboBox2, jComboBox3, jComboBox4, jLabel1, jLabel5, jLabel7, jLabel9});
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel13, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE)
                    .addComponent(jLabel14, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE)
        ...
        form1.setVOClassName(FiltroRecibo.class.getName());
            ...
            .addGroup(form1Layout.createSequentialGroup()
                ...
                .addGroup(form1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(form1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(codLookupControl2, javax.swing.GroupLayout.DEFAULT_SIZE, 455, Short.MAX_VALUE))
                    .addGroup(form1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(codLookupControl3, javax.swing.GroupLayout.DEFAULT_SIZE, 455, Short.MAX_VALUE))
                    .addGroup(form1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(codLookupControl4, javax.swing.GroupLayout.DEFAULT_SIZE, 455, Short.MAX_VALUE))
                    .addGroup(form1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(codLookupControl5, javax.swing.GroupLayout.DEFAULT_SIZE, 455, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, form1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(codLookupControl6, javax.swing.GroupLayout.DEFAULT_SIZE, 455, Short.MAX_VALUE))
                    .addGroup(form1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(codLookupControl7, javax.swing.GroupLayout.DEFAULT_SIZE, 455, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    class FiltroRecibos extends FormController implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            recibo = ((FiltroRecibo) FiltroRecibosDialog.this.form1.getVOModel().getValueObject());
            ...
            if (recibo.getCobrador() != null && recibo.getCobrador().getId() != null) {
                FilterWhereClause cob[] = new FilterWhereClause[2];
                cob[0] = new FilterWhereClause("cobrador2.id", "=", recibo.getCobrador().getId());
                vacio = false;
                filtros.put("cobrador2.id", cob);
            }
            if (recibo.getCompania() != null && recibo.getCompania().getId() != null) {
                FilterWhereClause com[] = new FilterWhereClause[2];
                com[0] = new FilterWhereClause("poliza.compania.id", "=", recibo.getCompania().getId());
                vacio = false;
                filtros.put("poliza.compania.id", com);
            }

            if (recibo.getGrupo() != null && recibo.getGrupo().getId() != null) {
                FilterWhereClause gru[] = new FilterWhereClause[2];
                gru[0] = new FilterWhereClause("poliza.grupoPoliza.id", "=", recibo.getGrupo().getId());
                vacio = false;
                filtros.put("poliza.grupoPoliza.id", gru);
            }

            if (recibo.getProductor() != null && recibo.getProductor().getId() != null) {
                FilterWhereClause pro[] = new FilterWhereClause[2];
                pro[0] = new FilterWhereClause("poliza.productor.id", "=", recibo.getProductor().getId());
                vacio = false;
                filtros.put("poliza.productor.id", pro);
            }

            if (recibo.getRamo() != null && recibo.getRamo().getId() != null) {
                FilterWhereClause ram[] = new FilterWhereClause[2];
                ram[0] = new FilterWhereClause("poliza.ramoPoliza.id", "=", recibo.getRamo().getId());
                vacio = false;
                filtros.put("poliza.ramoPoliza.id", ram);
            }

            if (recibo.getTipoZona() != null && recibo.getTipoZona().getId() != null) {
                FilterWhereClause zon[] = new FilterWhereClause[2];
                zon[0] = new FilterWhereClause("zona.id", "=", recibo.getTipoZona().getId());
                vacio = false;
