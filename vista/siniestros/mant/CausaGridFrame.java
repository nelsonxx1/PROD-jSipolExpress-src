...
import controlador.siniestros.mant.DetalleCausaGridInternalController;
 ...
 * @author bc
 */
public class CausaGridFrame extends DefaultGridFrame {
    ...
    private void initComponents() {
        ...
        gridControl1.setValueObjectClassName(DetalleCausaSiniestro.class.getName());
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Causa"));
        ...
        gridData.setValueObjectClassName(CausaSiniestro.class.getName());
    ...
    public void inicializar(GridDataLocator gridDataLocator, GridController gridController, String valueObjectClassName, String titulo, boolean addToMDIFrame) {
        ...
        controllerDetalle =
                new DetalleCausaGridInternalController(CausaSiniestro.class.getName(), "getDetalles", gridControl1, null);
