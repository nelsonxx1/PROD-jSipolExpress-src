package vista.siniestros.mant;

import controlador.siniestros.mant.DetalleDañoVehiculoGridInternalController;
 ...
 * @author bc
 */
public class DañoVehiculoGridFrame extends DefaultGridFrame {

    DefaultGridInternalController controllerDetalle;
    ...
    private void initComponents() {
        ...
        gridControl1.setValueObjectClassName(DetalleDañoVehiculo.class.getName());
        ...
        textColumn3.setColumnName("causa.nombre");
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addComponent(gridControl1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
        );

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Daño"));
        ...
        gridData.setValueObjectClassName(DañoVehiculo.class.getName());
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addComponent(gridData, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE)
        );
    ...
    public void inicializar(GridDataLocator gridDataLocator, GridController gridController, String valueObjectClassName, String titulo, boolean addToMDIFrame) {
        ...
        controllerDetalle =
                new DetalleDañoVehiculoGridInternalController(DañoVehiculo.class.getName(), "getDetalles", gridControl1, null);
        gridControl1.setGridDataLocator(controllerDetalle);
        gridControl1.setController(controllerDetalle);
