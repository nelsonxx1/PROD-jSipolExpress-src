...
public class BuscarHistorialPersonaDialog extends InternalFrame {

    private HistorialPersona persona;
    private Long idPersona;
    private boolean ok;

    public BuscarHistorialPersonaDialog(Component owner, Rif rif, Long idPersona) {
        this.idPersona = idPersona;
        initComponents();

        this.getRootPane().setDefaultButton(jButton1);

        jButton1.addActionListener(new RifDialogController());
    ...
    private void initComponents() {
        ...
        setResizable(false);
        setTitle("Rif - Historial");

        form1.setVOClassName(HistorialPersona.class.getName());
        ...
        numericControl2.setAttributeName("personaNatural.rif.numeroCedula");
        ...
        tipoCedula.setAttributeName("personaNatural.rif.tipoCedula");
        ...
        textControl1.setAttributeName("personaNatural.rif.cedulaCompleta");
        ...
        numericControl1.setAttributeName("personaNatural.rif.finRif");
        ...
        textControl2.setAttributeName("personaNatural.rif.rif");
    ...
    class RifDialogController extends FormController implements ActionListener {

        public void actionPerformed(ActionEvent e) {
            persona = (HistorialPersona) BuscarHistorialPersonaDialog.this.form1.getVOModel().getValueObject();
            ...
            if (tipoCedula.getSelectedIndex() >= 6) {
                ...
                BuscarHistorialPersonaDialog.this.form1.getVOModel().setValueObject(new Rif((TipoCedula) tipoCedula.getValue(), next));
            }
            if (rifConsulta != null) {
                System.out.println("Entrooooooo");
                System.out.println(p.getRif().getTipoCedula().getTipoPersona());
...
//                    new PersonasDetailController(null, (BeanVO) p, null);
//                }
                //BuscarHistorialPersonaDialog.this.dispose();
            } else {
                JOptionPane.showMessageDialog(null, "Esta persona no esta registrada");
//                ok = true;
//                rif = (Rif) (Rif) BuscarHistorialPersonaDialog.this.form1.getVOModel().getValueObject();
//                //BuscarHistorialPersonaDialog.this.dispose();
            }
        }
    }
