 ...
 * @author bc
 */
public class CoberturasGridInternalController extends DefaultGridInternalController {

    public CoberturasGridInternalController(String classNameModelFullPath, String getMethodName, GridControl miGrid, ArrayList<DefaultGridInternalController> listSubGrids) {
    ...
    public Response loadData(int action,
        ...
        if (beanVO != null) {
            al = s.createQuery("FROM " + Cobertura.class.getName() + " WHERE ramo.id=:ramoId").
                    setLong("ramoId", ((RamoPoliza) beanVO).getId()).list();
        } else {
    ...
    public Response insertRecords(int[] rowNumbers, ArrayList newValueObjects) throws Exception {
        ...
        if (getSet() != null) {
            ...
            try {
                ...
                //getSet().add(o);
                ((Cobertura) o).setRamo((RamoPoliza) super.beanVO);
