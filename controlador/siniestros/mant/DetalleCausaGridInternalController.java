 ...
 * @author bc
 */
public class DetalleCausaGridInternalController extends DefaultGridInternalController {

    public DetalleCausaGridInternalController(String classNameModelFullPath, String getMethodName, GridControl miGrid, ArrayList<DefaultGridInternalController> listSubGrids) {
    ...
    public Response insertRecords(int[] rowNumbers, ArrayList newValueObjects) throws Exception {
        ...
        if (getSet() != null) {
            ...
            try {
                ...
                getSet().add(o);
                ((DetalleCausaSiniestro) o).setCausa((CausaSiniestro) super.beanVO);
